...
extension DUTInfo {
    ...
    private func gotoNetPage() -> URLDataPromise {
        ...
        request.httpBody = """
            {
                "jsonrpc": "2.0",
                "method": "/dllg/login/prepareLogin",
                "id": "1",
                "params": ["\(studentNumber)", "\(portalPassword)", false]
    ...
    private func requestNetMoney(_ id: String) -> URLDataPromise {
        ...
        request.httpBody = """
            {
                "jsonrpc": "2.0",
                "method": "/user/charge/getChargeInfo",
                "id": 2,
                "params": [\(id)]
            }
            """.data(using: .utf8)
    ...
    private func requestNetFlow() -> URLDataPromise {
        ...
        request.httpBody = """
            {
                "jsonrpc": "2.0",
                "method": "/dllg/network/dayFlowRecords",
                "params":
                [{
                    "pageIndex":1,
                    "pageSize":10,
                    "filter":
                    {
                         "fromDate": "\(firstDateString)",
                         "toDate": "\(nowDateString)",
                         "accountId": "\(studentNumber)",
                         "businessInstanceName": "\(studentNumber)",
                         "businessTypeName": "\\u4e0a\\u7f51\\u670d\\u52a1"
                    }
                }],
                "id": 1
            }
